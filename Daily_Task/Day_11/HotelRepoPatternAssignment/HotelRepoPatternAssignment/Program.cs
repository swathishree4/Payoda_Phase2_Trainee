...
builder.Services.AddDbContext<HotelContext>(options => options.UseSqlServer("data source=PTSQLTESTDB01;database=Hotel_Swathi;integrated security=true;trustservercertificate =true;"));
